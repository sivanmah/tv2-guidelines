<script>
    ...
    let pageViews = 0; // Default value of page views
  ...
  <div>
    ...
    {#if estimatedCO2 !== null}
      <p>
        Sending {bytesSentMB || "0"} MB of data had a carbon footprint
        of {estimatedCO2.toFixed(3)} {emissionUnit === "tons" ? "tons" : "grams"} of CO2
      </p>
    {/if}
  </div>
